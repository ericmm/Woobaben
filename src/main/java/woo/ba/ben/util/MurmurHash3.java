...
import static woo.ba.ben.core.DataReaderFactory.LITTLE_ENDIAN_HEAP;
...
public class MurmurHash3 {
    ...
    public static int murmurhash3_x86_32(final byte[] data, final int offset, final int len, final int seed) {
        ...
        for (int i = offset; i < roundedEnd; i += 4) {
            ...
            int k1 = LITTLE_ENDIAN_HEAP.readInt(data, i);
            k1 *= c1;
     ...
     */
    public static void murmurhash3_x64_128(final byte[] key, final int offset, final int len, final int seed, final LongPair out) {
        ...
        for (int i = offset; i < roundedEnd; i += 16) {
            long k1 = LITTLE_ENDIAN_HEAP.readLong(key, i);
            long k2 = LITTLE_ENDIAN_HEAP.readLong(key, i + 8);
            k1 *= c1;
